...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-intercom-client/node_modules/intercom-client/dist/event.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-intercom-client/node_modules/intercom-client/dist/event.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-intercom-client/node_modules/intercom-client/dist/</a> &#187; event.js</div>
</div>
<div class="body">
...
&nbsp;
var Event = function () {
<span class="fstat-no" title="function not covered" >  function Event(client) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Event);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.client.post('/events', data, f);</span>
    }
  }, {
    key: 'listBy',
    value: <span class="fstat-no" title="function not covered" >function listBy(params, f) {</span>
<span class="cstat-no" title="statement not covered" >      return this.client.get('/events', params, f);</span>
    }
  }, {
    key: 'bulk',
    value: <span class="fstat-no" title="function not covered" >function bulk(params, f) {</span>
<span class="cstat-no" title="statement not covered" >      return new _bulk2.default(this.client, 'event').bulk(params, f);</span>
    }
  }]);
&nbsp;
  return Event;
